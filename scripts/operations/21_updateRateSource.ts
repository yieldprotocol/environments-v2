...
import { RATE, DAI, USDC } from '../../shared/constants'
...
;(async () => {
  ...
  const rateSources = jsonToMap(fs.readFileSync('./addresses/rateSources.json', 'utf8')) as Map<string, string>
  ...
  fs.writeFileSync('./addresses/rateSources.json', mapToJson(rateSources), 'utf8')
})()
