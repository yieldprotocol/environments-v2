npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/mocks/deployCurvePoolMock.ts &&
...
npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-2.ts &&
npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-2.ts &&
npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-2.ts &&

npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-3.ts &&
npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-3.ts &&
npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-3.ts &&

npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-4.ts &&
npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-4.ts &&
npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-4.ts &&

npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-5.ts &&
npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-5.ts &&
npx hardhat run --network localhost scripts/governance/addCompositeCollateral/convex/addCvx3Crv-5.ts