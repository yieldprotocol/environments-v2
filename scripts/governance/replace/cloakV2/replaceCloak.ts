...
import { TIMELOCK, CLOAK, WITCH } from '../../../../shared/constants'
import { Timelock__factory, EmergencyBrake__factory, Witch__factory } from '../../../../typechain'
...
;(async () => {
  ...
  proposal = proposal.concat(await addWitchToCloakFragment(signerAcc, cloak, witch, fyTokens, joins))
