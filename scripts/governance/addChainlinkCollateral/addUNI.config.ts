...
export const chainlinkSources: Map<number, Array<[string, string, string, string, string]>> = new Map([
  [
    ...
    [
      [
        UNI,
        (assets.get(1) as Map<string, string>).get(UNI) as string,
        ETH,
  ...
  [
    ...
    [
      [
        UNI,
        (assets.get(4) as Map<string, string>).get(UNI) as string,
        ETH,
        (assets.get(4) as Map<string, string>).get(ETH) as string,
        '0x5E4FaE1eCCAc5a120e48cC02012aF1aeFF94dACc',
      ],
    ],
  ],
  [
    ...
    [
      [
        UNI,
        (assets.get(42) as Map<string, string>).get(UNI) as string,
        ETH,
        (assets.get(42) as Map<string, string>).get(ETH) as string,
        '0xC0E69E49D98D26D52f7505Af1dF8b3009168f945',
      ],
    ],
  ],
])
