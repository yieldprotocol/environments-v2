...
$RUN $HERE/newEnvironment-25.ts # add series - propose
$RUN $HERE/newEnvironment-25.ts # add series - approve
$RUN $HERE/newEnvironment-25.ts # add series - execute

$RUN $HERE/newEnvironment-26.ts # deploy strategies

$RUN $HERE/newEnvironment-27.ts # orchestrate fyToken and strategies, initialize pools and strategies - propose
$RUN $HERE/newEnvironment-27.ts # orchestrate fyToken and strategies, initialize pools and strategies - approve
$RUN $HERE/newEnvironment-27.ts # orchestrate fyToken and strategies, initialize pools and strategies - execute
