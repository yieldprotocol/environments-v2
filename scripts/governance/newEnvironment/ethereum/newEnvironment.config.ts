...
export const chainlinkSources: Map<number, Array<[string, string, string, string, string]>> = new Map([
  [
    ...
    [
      [
        DAI,
        (assets.get(1) as Map<string, string>).get(DAI) as string,
        ETH,
        (assets.get(1) as Map<string, string>).get(ETH) as string,
        '0x773616E4d11A78F511299002da57A0a94577F1f4',
      ],
      [
        USDC,
        (assets.get(1) as Map<string, string>).get(USDC) as string,
        ETH,
        (assets.get(1) as Map<string, string>).get(ETH) as string,
      ...
      [
        WBTC,
        (assets.get(1) as Map<string, string>).get(WBTC) as string,
        ETH,
        (assets.get(1) as Map<string, string>).get(ETH) as string,
      ...
      [
        STETH,
        (assets.get(1) as Map<string, string>).get(STETH) as string,
        ETH,
        (assets.get(1) as Map<string, string>).get(ETH) as string,
      ...
      [
        LINK,
        (assets.get(1) as Map<string, string>).get(LINK) as string,
        ETH,
        (assets.get(1) as Map<string, string>).get(ETH) as string,
  ...
  [
    ...
    [
      [
        DAI,
        (assets.get(4) as Map<string, string>).get(DAI) as string,
        ETH,
        (assets.get(4) as Map<string, string>).get(ETH) as string,
        '0x74825DbC8BF76CC4e9494d0ecB210f676Efa001D',
      ],
      [
        USDC,
        (assets.get(4) as Map<string, string>).get(USDC) as string,
        ETH,
        (assets.get(4) as Map<string, string>).get(ETH) as string,
      ...
      [
        WBTC,
        (assets.get(4) as Map<string, string>).get(WBTC) as string,
        ETH,
        (assets.get(4) as Map<string, string>).get(ETH) as string,
      ...
      [
        STETH,
        (assets.get(4) as Map<string, string>).get(STETH) as string,
        ETH,
        (assets.get(4) as Map<string, string>).get(ETH) as string,
        '0x17AEAA7aF619Cf60095528cB115fbE22F14dFA44',
      ],
      [
        LINK,
        (assets.get(4) as Map<string, string>).get(LINK) as string,
        ETH,
        (assets.get(4) as Map<string, string>).get(ETH) as string,
      ...
      [
        ENS,
        (assets.get(4) as Map<string, string>).get(ENS) as string,
        ETH,
        (assets.get(4) as Map<string, string>).get(ETH) as string,
        '0x64EB137E967D1788Ce653C4Bdd4E4aD708F50Ae6',
      ],
    ],
  ],
  [
    ...
    [
      [
        DAI,
        (assets.get(42) as Map<string, string>).get(DAI) as string,
        ETH,
        (assets.get(42) as Map<string, string>).get(ETH) as string,
        '0x22B58f1EbEDfCA50feF632bD73368b2FdA96D541',
      ],
      [
        USDC,
        (assets.get(42) as Map<string, string>).get(USDC) as string,
        ETH,
        (assets.get(42) as Map<string, string>).get(ETH) as string,
      ...
      [
        WBTC,
        (assets.get(42) as Map<string, string>).get(WBTC) as string,
        ETH,
        (assets.get(42) as Map<string, string>).get(ETH) as string,
        '0xF7904a295A029a3aBDFFB6F12755974a958C7C25',
      ],
      [
        STETH,
        (assets.get(42) as Map<string, string>).get(STETH) as string,
        ETH,
        (assets.get(42) as Map<string, string>).get(ETH) as string,
        '0xF7904a295A029a3aBDFFB6F12755974a958C7C25',
      ],
      [
        LINK,
        (assets.get(42) as Map<string, string>).get(LINK) as string,
        ETH,
        (assets.get(42) as Map<string, string>).get(ETH) as string,
      ...
      [
        ENS,
        (assets.get(42) as Map<string, string>).get(ENS) as string,
        ETH,
        (assets.get(42) as Map<string, string>).get(ETH) as string,
        '0x19d7cCdB7B4caE085d3Fda330A01D139d7243Be4',
      ],
    ],
  ],
])
...
export const uniswapSources: Map<number, Array<[string, string, string, number]>> = new Map([
  [1, [[ETH, ENS, '0x92560c178ce069cc014138ed3c2f5221ba71f58a', 600]]],
...
export const assetsToReserve: Map<number, Array<[string, string]>> = new Map([
  [1, [[STETH, (assets.get(1) as Map<string, string>).get(STETH) as string]]],
  [4, [[STETH, (assets.get(4) as Map<string, string>).get(STETH) as string]]],
  [42, [[STETH, (assets.get(42) as Map<string, string>).get(STETH) as string]]],
])
