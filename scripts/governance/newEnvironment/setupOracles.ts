...
import { chainlinkSources, chiSources, rateSources, uniswapSources, lidoSource, compositeSources, compositePaths, yearnSources } from './newEnvironment.rinkeby.config'
