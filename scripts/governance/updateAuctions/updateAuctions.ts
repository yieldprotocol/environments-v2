...
import { updateWitchLimitsAndInitialOfferProposal } from '../../fragments/liquidations/updateWitchLimitsAndInitialOfferProposal'
...
;(async () => {
  ...
  proposal = proposal.concat(await updateWitchLimitsAndInitialOfferProposal(witch, newLimits))
