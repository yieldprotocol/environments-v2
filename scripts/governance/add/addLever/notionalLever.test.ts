...
;(async () => {
  ...
  let ethWhale = await getOwnerOrImpersonate('0x00000000219ab540356cBB839Cbe05303d7705Fa', WAD)
  ...
  await yieldNotionalLever
    .connect(ethWhale)
    .invest('0x303030390000', '0x323900000000', 2000e18, 30e18, { value: WAD.mul(2000) })
})()
