...
export const ePoolData: Array<[string, string, string, BigNumber, number]> = [
  [FYETH2212, assets.get(EWETH) as string, newFYTokens.get(FYETH2212) as string, timeStretch, g1],
  [FYUSDC2212, assets.get(EUSDC) as string, newFYTokens.get(FYUSDC2212) as string, timeStretch, g1],
  [FYDAI2212, assets.get(EDAI) as string, newFYTokens.get(FYDAI2212) as string, timeStretch, g1],
]
