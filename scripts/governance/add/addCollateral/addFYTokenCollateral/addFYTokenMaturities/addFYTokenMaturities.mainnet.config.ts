...
interface FyTokenSource {
  seriesId: string // FYToken id
  baseId: string // Underlying id
  pool: string // Address of pool where you can trade fyToken <-> underlying
}

export const fyTokenSources: FyTokenSource[] = [
  { seriesId: FYUSDC2209, baseId: USDC, pool: '0x' },
  { seriesId: FYDAI2209, baseId: DAI, pool: '0x' }
]
