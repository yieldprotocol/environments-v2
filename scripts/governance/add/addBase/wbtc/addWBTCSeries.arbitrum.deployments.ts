...
export const assetsToAdd: Map<string, string> = new Map([[WBTC, assets.get(WBTC)!]])
...
export const g1: number = 9000 // TODO
...
export const contractDeployments: ContractDeployment[] = [
  ...
  },
  {
    ...
    args: [
      ...
      () => EOMAR23.toString(),
      () => DISPLAY_NAMES.getOrThrow(FYWBTC2303),
      () => DISPLAY_NAMES.getOrThrow(FYWBTC2303),
    ],
    libs: {
