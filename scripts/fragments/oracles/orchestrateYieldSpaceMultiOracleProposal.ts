...
export const orchestrateYieldSpaceMultiOracleProposal = async (
  deployer: string,
  ...
  proposal.push({
    target: yieldSpaceMultiOracle.address,
    data: yieldSpaceMultiOracle.interface.encodeFunctionData('grantRole', [ROOT, cloak.address]),
  })
  console.log(`yieldSpaceMultiOracle.grantRole(ROOT, cloak)`)
