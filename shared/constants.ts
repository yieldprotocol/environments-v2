...
export const EWBTC = '0xE03314000000'
...
export const FYWBTC2303 = getSeriesId(WBTC, EOMAR23) // 0x0 033 FF 000 288
...
export const FYWBTC2306 = getSeriesId(WBTC, EOJUN23) // 0x0 033 FF 000 28B
...
export const FYWBTC2309 = getSeriesId(WBTC, EOSEP23) // 0x0 033 FF 000 28F
...
export const FYWBTC2303LP = getPoolId(WBTC, EOMAR23) // 0x2 033 FF 000 288
export const FYWBTC2306LP = getPoolId(WBTC, EOJUN23) // 0x2 033 FF 000 28B
...
export const FYWBTC2309LP = getPoolId(WBTC, EOSEP23) // 0x2 033 FF 000 28F
...
export const YSWBTC6MMS = getStrategyId(WBTC, 'MMS') // 1 033 FF 000 001 - Yield Strategy WBTC 6M Mar Sep - YSWBTC6MMS
export const YSWBTC6MJD = getStrategyId(WBTC, 'MJD') // 1 033 FF 000 000 - Yield Strategy WBTC 6M Jun Dec - YSWBTC6MJD
...
export const DISPLAY_NAMES = new Map([
  ...
  [FYWBTC2303LP, 'FYWBTC2303LP'],
  [FYWBTC2306LP, 'FYWBTC2306LP'],
  ...
  [YSWBTC6MMS, 'YSWBTC6MMS'],
  [YSWBTC6MJD, 'YSWBTC6MJD'],
