...
export const FDAI2309ID = fCashId(FCASH_DAI, FCASH_SEP23)
...
export const FUSDC2309ID = fCashId(FCASH_DAI, FCASH_SEP23)
...
export const FETH2309ID = fCashId(FCASH_ETH, FCASH_SEP23)
