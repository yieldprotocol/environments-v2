...
contract NotionalJoin is IJoin, ERC1155TokenReceiver, AccessControl {
    ...
    constructor(
        ...
        id = uint256((bytes32(uint256(currencyId_)) << 48) | (bytes32(uint256(maturity_)) << 8) | bytes32(uint256(1)));
    }
    ...
    function supportsInterface(bytes4 interfaceID) external view returns (bool) {
        ...
        return
            ...
            interfaceID ==
            ERC1155TokenReceiver.onERC1155Received.selector ^ ERC1155TokenReceiver.onERC1155BatchReceived.selector;
    }
    ...
    function onERC1155BatchReceived(
        ...
        for (uint256 i; i < length; ++i) require(_ids[i] == id, 'Token id not accepted');
