...
contract YvTokenMock is ISourceMock, ERC20Permit {
    ERC20 public token;
    uint256 public price;

    constructor(string memory name, string memory symbol, uint8 decimals, ERC20 token_) ERC20Permit(name, symbol, decimals) {
        token = token_;
    }
